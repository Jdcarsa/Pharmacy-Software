...
public class SearchEmployee extends javax.swing.JInternalFrame {
     ...
     * @param emp
     */
    public SearchEmployee(JLabel lb) {
        initComponents();
        setLocation(300, 200);
        this.toFront();
        this.lb = lb;    
        ...
        public SearchEmployee( IFindData find) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 850, 170));
