...
public class SearchPresentation extends javax.swing.JInternalFrame {
    ...
    private  JLabel lb;
    private ControllerPresentation presentation = new ControllerPresentation();
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        try {
            ...
            presentation.getAllPresentation(model);
    ...
    private void searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyReleased
               try {
            DefaultTableModel model = new DefaultTableModel();
            presentation.searchPresentation(model, this.search.getText().trim());
            this.jTable2.setModel(model);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(SearchPresentation.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
