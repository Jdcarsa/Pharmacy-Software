...
public class SearchProvider extends javax.swing.JInternalFrame {
   ...
   private IFindData find;
     ...
     * @param emp
     */
    public SearchProvider(JLabel lb) {
        initComponents();
        setLocation(300, 200);
        this.toFront();
        this.lb = lb;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 80, 30, 30));
        ...
        jLabel4.setText("Search Provider");
